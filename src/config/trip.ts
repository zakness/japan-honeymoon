...
export const TRIP_DAYS: TripDay[] = [
  ...
  { date: '2026-05-22', dayNumber: 8,  cities: ['tokyo', 'hakone'],    isTransit: true,  label: 'Tokyo → Hakone' },
  { date: '2026-05-23', dayNumber: 9,  cities: ['hakone'],             isTransit: false, label: 'Hakone' },
  { date: '2026-05-24', dayNumber: 10, cities: ['hakone', 'kyoto'],    isTransit: true,  label: 'Hakone → Kyoto' },
  ...
  { date: '2026-05-27', dayNumber: 13, cities: ['kyoto', 'naoshima'],  isTransit: true,  label: 'Kyoto → Naoshima' },
  { date: '2026-05-28', dayNumber: 14, cities: ['naoshima'],           isTransit: false, label: 'Naoshima' },
  { date: '2026-05-29', dayNumber: 15, cities: ['naoshima', 'osaka'],  isTransit: true,  label: 'Naoshima → Osaka' },
